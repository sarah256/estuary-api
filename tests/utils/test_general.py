...
@pytest.mark.parametrize('display_name,label,backward,expected', [
    ...
    ('python-requests-1.10-3', 'KojiBuild', False, 'Advisories attached to python-requests-1.10-3'),
    ...
    ('Freshmaker event 123456', 'FreshmakerEvent', False, 'Container builds triggered by Freshmaker event 123456'),
    ('Freshmaker event 123456', 'FreshmakerEvent', True, 'Advisories that triggered Freshmaker event 123456'),
    ('python-requests-1.10-3', 'ContainerKojiBuild', False, 'Container advisories attached to'
        ' python-requests-1.10-3'),
    ('python-requests-1.10-3', 'ContainerKojiBuild', True, 'Freshmaker events that triggered'
        ' python-requests-1.10-3'),
    ('RHBA-2018:1700-02', 'ContainerAdvisory', True, 'Container builds attached to RHBA-2018:1700-02')
])
